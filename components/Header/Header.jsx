...
function Header() {
  return (
    <header className="text-gray-700 body-font shadow border-b-2 border-gray-800">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav className="hidden md:flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
          ...
          <a className={Style.btn}>Find Your Photo</a>
          <a className={Style.btn}>Service</a>
        </nav>
        <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl">Wedding Gallery</span>
        </a>
